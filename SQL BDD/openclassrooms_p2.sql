...
--
-- Hôte : 127.0.0.1
-- Généré le : jeu. 11 déc. 2025 à 09:15
...
--
-- Base de données : `openclassrooms_p2`
--
...
INSERT INTO `oeuvres` (`oeuvres_id`, `titre`, `description`, `artiste`, `image`) VALUES
(1, 'Dodomu', 'Mia Tozerski est une  peintre ukrainienne réfugiée de la guerre. Sur cette œuvre, Dodomu (\"domicile\" en ukrainien) elle nous montre la tristesse du peuple ukrainien qu elle partage, ayant elle-même dû quitter son foyer. Lœuvre évoque le drapeau liquéfié dune Ukraine en souffrance,pleurant la mort de ses compatriotes. Ce travail chargé démo est le symbole dun événement qui marquera lHistoire. Cette peinture à lacrylique rayonne grâce à son fond lisse et ses mélanges de couleurs éclatantes\r\n', 'Mia Tozerski', 'img/clark-van-der-beken.png'),
...
(15, 'Blaue Gelbe Muster', 'Curabitur dui odio, porta vel tempor sed, consectetur vitae mi. Interdum et malesuada fames ac ante ipsum primis in faucibus. Orci varius natoque penatibus nec.', 'Adelhe Von Schreiber', 'img/steve-johnson-3.png'),
(19, 'Lumenor of Artbox', 'Ceci est une oeuvre générée via LumenorAI', 'David N', 'img/artbox3.png');
...
--
ALTER TABLE `oeuvres`
  MODIFY `oeuvres_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
COMMIT;
